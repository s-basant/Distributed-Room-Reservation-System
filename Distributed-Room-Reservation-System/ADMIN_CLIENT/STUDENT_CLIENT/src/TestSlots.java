	...
	public static void main(String[] args) throws InterruptedException {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				System.out.println(st.changeReservation("dvl_05-11-2017_56_3", "kkl", "56", "14:30 - 15:30", "wst4567"));
			}
		}).run();
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				System.out.println(st.bookRoom("dvl", "kkls4567", "56", "05-11-2017", "10:30 - 11:30"));
			}
		}).run();
