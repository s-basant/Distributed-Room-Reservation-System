...
public Server() {}
  ...
  public static void main(String[] args)
  {
    try
    {
        ...
        AdminImpl adminImpl = new AdminImpl("kkl");
        StudentImpl studentImpl = new StudentImpl("kkl");
        ...
        NameComponent path[] = ncRef.to_name( "kkl_admin_service" );
        ncRef.rebind(path, ref);
        
        NameComponent path1[] = ncRef.to_name( "kkl_student_service" );
        ncRef.rebind(path1, ref1);
        
        System.out.println("Server Started at KKL Campus");
