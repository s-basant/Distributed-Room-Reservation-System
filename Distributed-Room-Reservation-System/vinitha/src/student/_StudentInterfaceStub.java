...
public class _StudentInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements student.StudentInterface
{
  ...
  public String changeReservation (String booking_id, String new_campus_name, String new_room_no, String new_time_slot, String studentID, String newDate)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return changeReservation (booking_id, new_campus_name, new_room_no, new_time_slot, studentID, newDate        );
            } finally {
                _releaseReply ($in);
            }
  } // changeReservation
