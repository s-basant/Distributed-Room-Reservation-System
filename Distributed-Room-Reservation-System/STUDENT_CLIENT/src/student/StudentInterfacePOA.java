                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // student/StudentInterface/bookRoom
       {
         ...
         String $result = null;
         $result = this.bookRoom (serverName, campusName, studentID, roomNumber, date, timeslot);
         out = $rh.createReply();
       ...
       case 1:  // student/StudentInterface/getAvailableTimeSlot
       {
         ...
         String date = in.read_string ();
         String $result = null;
         $result = this.getAvailableTimeSlot (serverName, date);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
       ...
       case 2:  // student/StudentInterface/cancelBooking
       {
         ...
         $result = this.cancelBooking (serverName, bookingID, studentID);
         out = $rh.createReply();
       ...
       case 3:  // student/StudentInterface/changeReservation
       {
         ...
         String $result = null;
         $result = this.changeReservation (serverName, booking_id, new_campus_name, new_room_no, new_time_slot, studentID, newDate);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
